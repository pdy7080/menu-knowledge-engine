...
class TranslationCleaner:
    ...
    def clear_all_translations(self):
        ...
        print("[DONE] All ja/zh translations cleared")
        ...
        try:
            response = await self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are a Korean cuisine expert. Translate naturally without any prefix like [JA] or [ZH].",
                    },
        ...
        menus_to_translate = [
            {
                "id": m.id,
                "name_ko": m.name_ko,
                "desc_en": m.explanation_short.get("en", ""),
            }
            for m in menus_db
