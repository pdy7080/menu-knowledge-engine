...
async def main():
    ...
    print(f"\n[STEP 2] 실제 GPT-4o 번역 실행")
    print(f"  - 명령어:")
    print(f"    python scripts/translate_canonical_menus_gpt4o.py --language ja,zh --batch-size 10")

    print(f"\n" + "=" * 80)
    print(f"[COMPLETE] Cleanup 완료! 이제 translate_canonical_menus_gpt4o.py를 실행하세요.")
    print("=" * 80)
