...
"""
            ...
            if "RESOURCE_EXHAUSTED" in error_msg or "429" in error_msg:
                ...
                print(f"   내일 다시 실행하세요: python scripts/enrich_priority_batch.py --batch {self.batch_num}")
    ...
    def save_results(self):
        """배치 결과 저장"""
        output_path = BASE_DIR.parent.parent / "data" / f"enriched_batch_{self.batch_num}.json"
