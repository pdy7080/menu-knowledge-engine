...
class GeminiEnricher:
    ...
    def enrich_menu(self, menu: CanonicalMenu, retry_count: int = 0) -> Optional[Dict[str, Any]]:
...
"""
    ...
    def save_checkpoint(self, count: int):
        """체크포인트 저장"""
        checkpoint_path = BASE_DIR.parent.parent / "data" / f"checkpoint_gemini_{count}.json"
