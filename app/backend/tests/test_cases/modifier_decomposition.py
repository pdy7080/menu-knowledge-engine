...
MODIFIER_CASES = [
    ...
    # 다중 수식어 (핵심 테스트!)
    ("왕얼큰뼈해장국", "뼈해장국", "modifier_decomposition"),  # "왕" + "얼큰" + "뼈해장국"
    ("할머니얼큰순두부찌개", "순두부찌개", "modifier_decomposition"),  # "할머니" + "얼큰" + "순두부찌개"
    ("한우숯불갈비", "갈비", "modifier_decomposition"),  # "한우" + "숯불" + "갈비"
    ("옛날얼큰손칼국수", "손칼국수", "modifier_decomposition"),  # "옛날" + "얼큰" + "손칼국수"

    # 복합 케이스
    ("왕돈까스정식", "돈까스", "modifier_decomposition"),  # "왕" + "돈까스" + "정식"(접미사)
    ("한우불고기1인분", "불고기", "modifier_decomposition"),  # "한우" + "불고기" + "1인분"(접미사)
    ("할머니김치찌개세트", "김치찌개", "modifier_decomposition"),  # "할머니" + "김치찌개" + "세트"(접미사)
    ("특대왕갈비", "갈비", "modifier_decomposition"),  # "특" + "대" + "왕" + "갈비"

    # 엣지 케이스
    ("고씨네묵은지감자탕", "감자탕", "modifier_decomposition"),  # "고씨네" + "묵은지" + "감자탕"
